...
if (!empty($_SESSION['login']) and !empty($_SESSION['password']))
            ...
            exit("Вход на эту страницу разрешен только зарегистрированным пользователям!"); }
            $result = mysqli_query($db, "SELECT * FROM `users_1` WHERE `id` = '$id'"); 
...
if (!empty($messages['id'])) {
            ...
            $result4 = mysqli_query($db, "SELECT `avatar`, `id` FROM `users_1` WHERE `login` = '$author'"); //извлекаем аватар автора 
