...
$result = mysqli_query($db, "SELECT id,avatar FROM users_1 WHERE login='$login' AND password='$password' AND activation='1'"); 
...
//проверяем, не извлечены ли данные пользователя из базы. Если нет, то он не вошел, либо пароль в сессии неверный. 
...
Вы вошли на сайт, как, как $_SESSION[login] (<a href='exit.php'>выход</a>)<br>
<!--выше ссылка на выход из аккаунта -->
<a href='http://mail.ru/'>Эта ссылка доступна только зарегистрированным пользователям</a><br>
Ваш аватар:<br>
